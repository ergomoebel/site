...
class Fields extends CompositeForm implements FormInterface
{
    ...
    protected function modifyMeta(array &$meta): void
    {
        ...
        $fields = &$meta['fields']['children']['fieldsConfigAdvanced']['children']['customer_entity']['children'];
        $this->processPrefixFields($fields);

        $meta['fields']['children']['fieldsConfigAdvanced']['children']
        ['customer_entity']['children']['field_postfix'] = $fieldPostfixMeta;
        $meta['fields']['children']['fieldsConfigAdvanced']['children']
        ['customer_entity']['children']['use_custom_prefix'] = $useCustomPrefixMeta;
        $meta['fields']['children']['fieldsConfigAdvanced']['children']
        ['customer_entity']['arguments']['data']['config'] = [
            'label' => __('Customer'),
            'componentType' => 'fieldset',
            'visible' => true,
            'collapsible' => true,
            'opened' => true,
            'additionalClasses' => 'amcustomerimport-fieldset-withtooltip',
            'template' => 'Amasty_CustomerImport/form/fieldset',
            'tooltipTpl' => 'Amasty_ImportCore/form/element/tooltip',
            'tooltip' => [
                'description' => '<img src="'
                    . $this->assetRepo->getUrl(
        ...
        $codeOutputField = &$meta['fields']['children']['fieldsConfigAdvanced']['children']
                            ['customer_entity']['children']['field_code_input']['arguments']['data']['config'];
        $codeOutputField = array_merge($codeOutputField, [
            'sortOrder' => 1,
            'componentType' => 'field',
            'formElement' => 'input',
            'label' => __('Custom Entity Key'),
            'component' => 'Amasty_CustomerImport/js/form/element/input',
            'tooltipTpl' => 'Amasty_ImportCore/form/element/tooltip',
            'tooltip' => [
                'description' => '<img src="'
                    . $this->assetRepo->getUrl(
        ...
        $meta['fields']['children']['fieldsConfigAdvanced']['children']
            ['customer_entity']['children']['addField']['arguments']['data']['config']['sortOrder'] = 10;
    }
    ...
    private function processPrefixFields(array &$fields): void
    {
        foreach ($fields as $fieldName => &$field) {
            ...
            $field['children'][$fieldName . '_container']['children']['field_code_input']
                ['arguments']['data']['config']['component'] = 'Amasty_CustomerImport/js/form/element/custom-prefix';
