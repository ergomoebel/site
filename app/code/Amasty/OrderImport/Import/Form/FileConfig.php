...
class FileConfig extends CompositeForm implements FormInterface
{
    ...
    public function getData(ProfileConfigInterface $profileConfig): array
    {
        ...
        $prefix = $result['extension_attributes'][$profileConfig->getSourceType() . '_source']['prefix'] ?? null;
        if ($prefix) {
            $profileConfig->getExtensionAttributes()->setFieldPostfix($prefix);
        }
    ...
    public function prepareConfig(ProfileConfigInterface $profileConfig, RequestInterface $request): FormInterface
    {
        ...
        $sourcePostfix = $params['fields']['fields']['sales_order']['field_postfix'] ?? null;
