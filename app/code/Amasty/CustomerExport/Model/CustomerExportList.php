...
namespace Amasty\CustomerExport\Model;
...
class CustomerExportList extends \Magento\Framework\DataObject implements \Iterator
{
    /**
    ...
    public function __construct(
        ...
        foreach ($collection->getItems() as $item) {
            $options[] = [
                'value' => $item->getId(),
                'label' => $item->getName(),
                'url' => 'amcustomerexport/customer/export/profile_id/' . $item->getId(),
                'is_amasty_profile' => true,
                'statusUrl' => $url->getUrl('amexport/export/status'),
                'startUrl' => $url->getUrl('amcustomerexport/profile/export'),
