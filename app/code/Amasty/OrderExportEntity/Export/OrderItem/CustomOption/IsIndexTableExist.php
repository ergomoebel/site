...
namespace Amasty\OrderExportEntity\Export\OrderItem\CustomOption;
...
/**
 * Index table existence checker
 */
class IsIndexTableExist
{
    /**
    ...
    public function isEnabled(): bool
    {
        ...
        return (bool)$this->connection->getConnection()->isTableExists(
            $this->connection->getTableName('amasty_order_export_custom_option_index')
        );
    }
}
