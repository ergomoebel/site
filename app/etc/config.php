...
return [
    'modules' => [
        ...
        'Amazon_Login' => 1,
        'Amazon_Payment' => 1,
        'Bezigeboefjes_ChangeAttributeSet' => 1,
        'Bold_OrderComment' => 1,
        'C4B_FreeProduct' => 1,
        'CopeX_VATFix' => 1,
        'Dotdigitalgroup_Email' => 1,
        'ESPL_Onepagecheckout' => 0,
        'Economix_DbTranslations' => 1,
        'FireGento_MageSetup' => 1,
        'Netresearch_OPS' => 1,
        'Klarna_Core' => 1,
        'Klarna_Ordermanagement' => 1,
        'Klarna_Kp' => 1,
        'Leitner_LeitnerShop' => 1,
        'Limesharp_Stockists' => 1,
        'Lucasart_StockStatusLabel' => 1,
        'Magento_PaypalReCaptcha' => 1,
        'MSP_TwoFactorAuth' => 1,
        'MageKey_ProductSliderWidget' => 1,
        ...
        'Ingenico_OPS' => 1,
        'Patrickfuchshofer_Giftvoucher' => 1,
        'Payone_Core' => 0,
        'Scandiweb_Core' => 1,
        'Scandiweb_LocaleResolverFix' => 1,
        'Scandiweb_Slider' => 1,
        'SharpMonks_PaymentFilter' => 0,
